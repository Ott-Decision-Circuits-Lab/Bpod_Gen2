...
%
% Example:
% SoundCal = SoundCalibration_Manual([1000 80000], 5000, 60, 2); % Measure
% attenuation factors for 40 frequencies between 1khz and 80kHz in steps of 2000
% such that a full scale tone * attenuation factor --> 60dB. Return a best-fit polynomial function for interpolation.
%
...
%Run the script
SoundCal = SoundCalibration_Manual([1000 20000], 500, 60, 2);
save("SoundCalibrationNew.mat","SoundCal");
