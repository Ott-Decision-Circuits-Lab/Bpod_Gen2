...
try
    if ~isempty(TaskParameters) && sum(strcmp(fieldnames(TaskParameters.GUI), 'EphysSession')) == 1 && TaskParameters.GUI.EphysSession
        ...
        try
            ...
            disp('Warning: BpodSystem Info not found. Ephys data not saved to database!')
            return
        end
        ...
        try
            ...
            disp('Warning: CurrentDataFile not found. Ephys data not saved to database!')
            return
        end
        ...
        try
            ...
            disp('Warning: Unable to connect to ott_lab database: Ephys data not saved to database!')
            return
        end
        ...
        try
            ...
            disp('Error: Unsucessful creation of ephys table.')
            close(conn)
            return
        end
        ...
        try
            ...
            disp('Error: Unsucessful writing to ephys_experiment.')
            close(conn)
            return
        end
