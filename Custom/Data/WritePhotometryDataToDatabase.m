...
try
    ...
    photometry_info.photometry_info = [string(SessionMeta.PhotometryGreenSensor), "470", SessionMeta.PhotometryGreenAmplification;...
                                       string(SessionMeta.PhotometryRedSensor), "555", SessionMeta.PhotometryRedAmplification];
