function AnalogOutputWavePlayerTriggerProfile()
%{
...
Updated by Antonio Lee @2022-10-19
%}
...
trigger_matrix = ones(64, 8)*256; % please keep sound index 64 always empty
trigger_matrix(1,1:2) = [2 3];
trigger_matrix(2,1:2) = [1 2];
Player.TriggerProfiles = trigger_matrix;
LoadSerialMessages('WavePlayer1', {['P' 1], ['P' 2]});
